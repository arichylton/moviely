...
class MoviePage extends React.Component {
    ...
    if (revenue - budget >= 0) {
      return (
        <span className='movie-span' style={{ color: '#21ba45' }}>
          ...
          {this.commafy(
            this.props.movieData.revenue - this.props.movieData.budget
          )}
        </span>
      );
    } else {
    ...
    if (!this.props.movieData.title) {
      ...
      return (
        <div style={{ paddingTop: 140 }} className='ui container'>
          <h1
            className='moviePage-h1 animated fadeInDown'
          ...
          <Breakpoint xlarge only>
            <div>
              <div className='ui two column grid'>
                ...
                <div
                  className='column animated fadeInRight'
                  style={{ marginTop: 10 }}
                >
                  <div className='movie-div'>
                    <h4 className='movie-h4'>
                      ...
                      <span className='movie-span'>
                        {parseFloat(this.props.movieData.runtime / 60).toFixed(
                          2
                        )}{' '}
                        hours
                      </span>
                  ...
                  <div className='movie-div'>
                    <h4 className='movie-h4'>
                      Profit:{' '}
                      {this.profit(
                        this.props.movieData.revenue,
                        this.props.movieData.budget
                      )}
                    </h4>
                  </div>
                </div>
          ...
          <Breakpoint medium down>
            <div>
              ...
              >
                ...
                <div
                  className='column animated fadeInRight'
                  style={{ marginTop: 10, textAlign: 'center', width: 350 }}
                >
                  <div className='movie-div'>
                    <h4 className='movie-h4'>
                      Runtime:{' '}
  ...
  render() {
    return (
      <div className='moviePage-background' style={{ paddingBottom: 80 }}>
